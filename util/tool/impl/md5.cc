...
std::string CMD5::MD5_String(const char *szText)
{
    ...
    //strncpy(pOut,szMD5StringBuffer,32);
}


std::string CMD5::MD5_Buffer(const void *pData, int nLength)
{
    char szMD5StringBuffer[33];
    memset(szMD5StringBuffer,0,33);
    ...
    MD5Update( &context, (unsigned char*)pData, nLength );
