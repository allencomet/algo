...
//Returns false if n is multiple of 8
bool CBlowFish::Decrypt(unsigned char* buf, size_t n, int iMode)
{
	//Check the buffer's length - should be > 0 and multiple of 8
	if((n==0)||(n%8!=0))
    {
...
//Returns false if n is multiple of 8
bool CBlowFish::Encrypt(const unsigned char* in, unsigned char* out, size_t k, int iMode)
{
	//Check the buffer's length - should be > 0 and multiple of 8
...
//Returns false if n is multiple of 8
bool CBlowFish::Decrypt(const unsigned char* in, unsigned char* out, size_t k, int iMode)
{
